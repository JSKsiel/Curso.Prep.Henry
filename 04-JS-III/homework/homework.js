...
function empiezaConNueve(n) {
  ...
  if (numberToString[0]=== "9") return true;
  else return false;
...
function mesesDelAño(array) {
 ...
 if (mesesPedidos.lenght === 3) return mesesPedidos;
...
function breakStatement(numero) {
  ...
  var nuevosValores = [];
   ...
   } if( nuevosValores.length < 10) return "Se interrumpio la ejecución"
